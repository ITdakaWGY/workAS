...
function(t, a, e, i) {
    var n = function(a, e) {
		...
		this.pageCount=this.opts.pageCount,
    ...
    n.prototype = {
        ...
        render: function() {
            ...
            i = this.getPagesTpl(),
            n = this.ele.empty();
			this.totalPageText = '<a href="javascript:void(0);" class="pageCount">共查询到<font>'+pageCount+'</font>条数据'+'</a>';
            this.isRender = !0,
            ...
            this.checkPage(),
            this.isRender && n.html("<div class='ui-pagination-container'>" + this.homePage + this.prevPage + i + this.nextPage + this.endPage +this.totalPageText+ "</div>")
        },
        checkPage: function() {
            var t = this.opts,
            a = this.total,
